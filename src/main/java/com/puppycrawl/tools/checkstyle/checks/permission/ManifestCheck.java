...
import com.puppycrawl.tools.checkstyle.permission.ManifestHelper;
import com.puppycrawl.tools.checkstyle.utils.CommonUtil;

public class ManifestCheck extends AbstractCheck {
    ...
    private void checkHasPermission(DetailAST commentAst) {
        ...
        String oneLineComment = CommentUtil.makeCommentInOneLine(commentLine);
        String value = getValue(commentAst);
        String desc = getDesc(commentAst);

        ManifestHelper.getInstance().recordPerm(oneLineComment, value, desc);
    }

    private String getValue(DetailAST commentAst) {
